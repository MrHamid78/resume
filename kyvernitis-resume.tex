...
%		\item Implemented key features such as invoice generation, inventory management, and sales tracking to streamline store operations and improve efficiency.
...
%		\item Enhanced user experience with a responsive and intuitive interface, allowing staff to easily manage transactions and track store performance.
...
\sectiontable{Technical skills}{
	...
	\entry{Databases}{MySQL, ORACLE}
	\entry{Version Control}{Git}
	\entry{Web Development}{HTML, CSS, JavaScript, jQuery, Angular}
